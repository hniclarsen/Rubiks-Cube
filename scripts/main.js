...
function draw() {
    ...
    for(let cube in state.rCube.cubes) {
        ...
        if(rotate) {
            if(0/*state.rCube.matrices.bottom.arr[cube]*/) {
                drawRotation(state.rCube.cubes[cube].num, x, y, z);
            } else drawCube(state.rCube.cubes[cube].num, x, y, z);
        }
        else drawCube(state.rCube.cubes[cube].num, x, y, z);
...
function drawRotation(cube, x, y, z) {
